...
export const products: Product[] = [
  {
    ...
    slug: 'free-flyer',
    name: 'WEEKLY FLYER',
    description: 'Try a free weekly events flyer: every show, every venue, double-sided trifold, printable pdf.',
    price: null,
    recurring: false,
    comingSoon: true,
  ...
  },
  {
    ...
    description: 'Get the weekly flyer delivered to your inbox every Monday morning. Print at home and never miss a show.',
    price: '$10/mo',
    recurring: true,
    comingSoon: true,
    requiresAddress: false,
